...
const packageIncludes = ["@babel/runtime", "lodash.isequal", "lodash.clonedeep", "@types/lodash.clonedeep", "@adifkz/exp-p"];
...
//   const files = await glob(['**/*.d.ts', '!**/*.stories.d.ts'], { cwd: from });
...
async function addLicense(packageData) {
  const license = `/** @license React Form Schema v${packageData.version}
 *
